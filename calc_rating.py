...
# Load the CSV file
file_path = "concepts\sarcasm\gcav_results_sarcasm_run_reversed\steering_outputs_SS_9_layer11_40_prompts_rated_by_antigravity.csv"#"concepts/empathy/steering_outputs_SS_9_layer11_40_prompts_rated.csv"
...
print(f"Average Rating for 'positive' class with steering strength -9: {average_rating:.2f}")
